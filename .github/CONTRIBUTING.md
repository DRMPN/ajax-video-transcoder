# Contributing to ajax-video-transcoder

We welcome you to [check the existing issues](https://github.com/DRMPN/ajax-video-transcoder/issues) for bugs or enhancements to work on.
If you have an idea for an extension to ajax-video-transcoder, please [file a new issue](https://github.com/DRMPN/ajax-video-transcoder/issues/new) so we can discuss it.

Make sure to familiarize yourself with the project layout before making any major contributions.

## How to contribute

1. Fork the [project repository](https://github.com/DRMPN/ajax-video-transcoder/): click on the 'Fork' button near the top of the page. This creates a copy of the code under your account on the GitHub server.

2. Clone this copy to your local disk:

   ```bash
   git clone git@github.com:YourUsername/ajax-video-transcoder.git
   ```
...
Finally, go to the web page of your fork of the ajax-video-transcoder repo, and click
...
If your contribution changes ajax-video-transcoder in any way:

- Update the [README](https://github.com/DRMPN/ajax-video-transcoder/tree/master/README.md) if anything there has changed.
